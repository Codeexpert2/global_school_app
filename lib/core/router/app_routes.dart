...
enum AppRoutes {
  ...
  studentCalendar('/student/studentCalendar', 'studentCalendar'),
  ...
  studentSuccessquiz('/student/successquiz', 'studentSuccessquiz'),
  studentFailurequiz('/student/failurequiz', 'studentFailurequiz'),
  studentOnlineLesson('/student/onlineLesson', 'studentOnlineLesson'),
  studentOnlineLessonDetails(
      '/student/onlineLesson/:lessonId', 'studentOnlineLessonDetails'),
  studentCertificateDetails(
      '/student/certificate/:id', 'studentCertificateDetails'),
  studentOfflineLessons('/student/offlineLesson', 'studentOfflineLesson'),
  studentOfflineLessonsDetails(
      '/student/offlineLesson/:lessonId', 'studentOfflineLessonDetails'),
